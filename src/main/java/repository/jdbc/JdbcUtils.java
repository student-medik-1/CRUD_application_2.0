...
public class JdbcUtils {
    ...
    public static final String WRITER_CREATE = "INSERT INTO writers (first_name, last_name, posts, region_name) " +
            "VALUES(?,?,?,?)";
    public static final String WRITER_UPDATE = "UPDATE writers SET first_name = ?, last_name = ?, posts = ?, region_name = ?"
                                      + "WHERE id = ?";
    ...
    public static final String POST_CREATE = "INSERT INTO posts (posts, created) VALUES(?,?)";
    public static final String POST_UPDATE = "UPDATE posts SET posts = ?, created = ? updated = ?  WHERE id = ?";
